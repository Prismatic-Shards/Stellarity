...
execute unless score #stellarity.config stellarity.config.lock_the_end matches 1 run data modify storage stellarity:temp stellarity.config.mechanic.dialog.inputs[{key:"lock_the_end"}].options[1].initial set value false