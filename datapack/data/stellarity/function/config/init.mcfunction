...
execute unless score #stellarity.config stellarity.config.lock_the_end matches ..2147483647 run scoreboard players set #stellarity.config stellarity.config.lock_the_end 0
